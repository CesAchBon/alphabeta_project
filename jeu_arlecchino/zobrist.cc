...
zobrist::zobrist() : _tableau_indice_zobrist(4,std::vector<std::vector<std::vector<unsigned long long int>>>(36,std::vector <std::vector<unsigned long long int>>(36,std::vector<unsigned long long int>(4,-1)))) {
    buildTableauIndice();
}
...
unsigned long long int zobrist::buildKeyZobrist(const int &couleur,const board &plateau,const int &profondeur){
    int numCase = 0;
